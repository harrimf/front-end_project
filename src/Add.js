...
//Code to Add Artifact to Database
...
class Add extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    if(this.state.name !== "" && this.state.description !== "" && this.state.country !== "" && this.state.image !== "") {

      var object = {name: this.state.name, description: this.state.description, country: this.state.country, imageURL: this.state.image};

      const response = await fetch(`http://ec2-35-92-179-216.us-west-2.compute.amazonaws.com:8080/api/artifact`, {method: 'POST', headers: new Headers({'content-type': 'application/json'}), body: JSON.stringify(object)});
        ...
        <Container>
          <Row className='headerRow'>
            <Col className='museCol'>
              <h2 className='valueH2'>Add an Artifact</h2>
              <p className='valueP'>Fill out the form, to register a new artifact in MUSE</p>
              ...
              <Form>
                ...
                <Form.Group className='museForm' controlId="formBasicEmail">
                  ...
                  <Form.Control.Feedback type='invalid'>
                    {this.state.country === "" ? "This field cannot be empty" : "Please enter country of origin"}
